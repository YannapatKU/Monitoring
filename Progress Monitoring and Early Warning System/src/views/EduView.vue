<template>
  <div class="main-layout-toggable">
    ...
    <div class="content-wrapper">
      ...
      <DataTable showGridlines style="width: 90%; margin: 0 auto; margin-top: 2rem;">
        <Column field="OverallCredits" header="หน่วยกิตสะสม" />
        <Column field="OverallGPA" header="เกรดเฉลี่ยสะสม" />
      </DataTable>
